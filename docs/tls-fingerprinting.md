...
The native library is bundled inside the JAR for Linux, macOS, Windows and Android. JNA loads it at runtime. You don't compile Go, install anything, or set `LD_LIBRARY_PATH`.
